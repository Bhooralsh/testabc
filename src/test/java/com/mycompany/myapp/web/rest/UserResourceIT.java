...
import com.mycompany.myapp.TestabcApp;
...
@SpringBootTest(classes = TestabcApp.class)
public class UserResourceIT {
    ...
    public void deleteUser() throws Exception {
        ...
        // Delete the user
        restUserMockMvc
            .perform(delete("/api/users/{login}", user.getLogin()).accept(MediaType.APPLICATION_JSON).with(csrf()))
